...
if page == "📊 Overview":
    st.markdown('<div class="main-header">🌤️ Weather Forecasting & Alert System</div>', unsafe_allow_html=True)
    ...
    st.markdown("### 🌡️ Temperature Time Series Overview")
